...
class CategoryUrlsTest(TestCase):
    ...
    @tag("unit-test")
    def test_showCreateCourseView(self):
        # Act
        url = reverse("Category:create-course")
        # Assert
        self.assertEqual(resolve(url).func.view_class, CreateCourseView)

    @tag("unit-test")
    def test_showdeleteCourse(self):
        # Act
        url = reverse("Category:delete-course", kwargs={"course_id": self.course.id})
        # Assert
